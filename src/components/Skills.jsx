    ...
    return (
        <div className="bg-[#5359B9] sm:py-[70px]" id="skills">
            <div className="w-full mx-auto max-w-6xl p-5">
                <div className="flex flex-col gap-5 mx-5 items-center justify-center md:flex-col lg:flex-row ">
                    <div className="w-full md:w-1/2 lg:w-1/2">
                        ...
                        <p className="text-white font-medium pb-[25px]">
                            ...
                            <br /> desire to solve problems and create value.{' '}
                            <br /> I'm always looking for new challenges <br />{' '}
                    ...
                    <div className="flex flex-col">
                        <div className="flex mb-5 gap-[40px] sm:gap-[80px]">
                            <div className="flex flex-col text-center justify-center items-center w-[100px] bg-white h-[100px] rounded-md text-black font-bold cursor-pointer transform transition-transform duration-300 hover:scale-110 hover:-translate-y-2 hover:rotate-2 sm:w-[190px] sm:h-[150px]">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 512 512"
                                    className="w-9 sm:w-14 pb-3"
                                >
