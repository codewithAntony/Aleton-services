                ...
                <div className="flex flex-col gap-[30px] mx-[20px] items-center justify-center md:flex-col lg:flex-row ">
                    <div className="w-full md:w-1/2 lg:w-2/3">
                        ...
                        <p className="text-white font-medium pb-[25px]">
                            I have a deep passion for my work,fueled by the
                            desire to solve problems and create value. <br />{' '}
                            I'm always looking for new challenges and
                            opportunities to grow and improve.
                        </p>
                        {/* <p className="text-white font-medium pb-[16px]">
                            With my experience in Digital Marketing, through
                            SEO(Search Engine Optimization) I will help users
                    ...
                    <div className="flex flex-col">
                        <div className="flex mb-5 gap-[40px]">
                            <div className="flex flex-col text-center justify-center items-center w-[100px] bg-white h-[100px] rounded-md text-black font-bold cursor-pointer sm:w-[150px] sm:h-[150px]">
                                <svg
